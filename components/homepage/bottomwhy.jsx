...
export default function bottomwhy(){
    ...
    <p className='text-center text-3xl font-extrabold mt-8'>WHY CHOOSE US?</p>
        <div className='place-content-center flex flex-col md:flex-row pt-8 p-8 '>
           <div className='flex flex-col my-4 border-2 p-4 m-2 text-gray-400 hover:text-white
           bg-white hover:bg-indigo-500 transition-all duration-700'>
           ...
           <SendIcon  style={{ fontSize: '48px' }}/>
            ...
            <h2 className='uppercase text-center text-xl font-bold text-black' data-aos="fade-right">we make it faster</h2>
            <p className="overflow-clip pt-2 font-semibold text-center md:px-16">
           ...
           <div className=' h-20 w-20 rounded-full bg-yellow-500 ring-4 ring-white pl-4 pt-6 mb-4 m-auto text-white'>
            ...
            <h2 className='uppercase text-center text-xl font-bold text-black' data-aos="fade-right">AVAILABLE AT YOUR LOCATION</h2>
            <p className="overflow-clip pt-2 font-semibold text-center md:px-16">
            We serve over 15 locations across the country and have 15 self-owned, 
            fully computerized branches. Our head office is in Bangalore. Sheoran International Packer & Mover offers 24 hours’ door to door services and it promises what it does.
            </p>
           </div>
           ...
           <TimerIcon  style={{ fontSize: '48px' }}/>
            ...
            <h2 className='uppercase text-center text-xl font-bold text-black' data-aos="fade-right">ON TIME DELIVERY</h2>
            <p className="overflow-clip pt-2 font-semibold text-center md:px-16">
