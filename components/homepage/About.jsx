...
function About() {
  return (
      <div className='md:px-8 px-4 py-14 bg-gray-200'>
    <div className='flex flex-col bg-white md:flex-row rounded-md'>
        <div className='flex py-auto flex-1 drop-shadow-2xl'>
            <div className='mx-8 mb-2 mt-4 md:mx-6'>
            <p  className='mt-2 text-3xl uppercase pointer text-black font-sans font-extrabold md:px-4'>who we are</p>
            <p className='font-semibold md:px-4 overflow-clip mt-2 text-gray-400'>
