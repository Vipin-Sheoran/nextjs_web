...
function Testimonials() { 
    ...
    return (
        <div>
            ...
            <div className='p-4'>
            <div data-aos="zoom-out-right" className='bg-black bg-opacity-50 w-full p-8 mt-6 md:w-96 md:h-64'>
               ...
               <p className='text-center text-white pt-2'>Thanks, Sheoran International Packer & Mover for all your support to shift
                    my household goods Delhi To Bangalore</p>
             <p className='text-xl text-yellow-500 text-center font-bold'>Rajesh Mital</p>
             <p className='text-center text-white'>( Delhi )</p>
            </div>
            </div>
            ...
            <div className='w-12 h-12 mx-auto w-12 h-12 mx-auto w-12 h-12 mx-auto'>
               ...
               <p className='text-center text-white pt-2'>Professional service. We transfer my household Gurgaon to Mumbai. I received my goods safely.</p>
                    <p className='text-xl text-yellow-500 text-center font-bold'>Punam</p>
             <p className='text-center text-white'>( Gurgaon )</p>
            </div>
            </div>
            ...
            <div className='w-12 h-12 mx-auto w-12 h-12 mx-auto w-12 h-12 mx-auto'>
               ...
               <p className='text-center text-white pt-2'>Thanks again to your team. This is my 4 time hire Sheoran International Packer & Mover. 
             ...
             <p className='text-center text-white'>( Noida )</p>
            </div>
            </div>
            </div>
            </div>
