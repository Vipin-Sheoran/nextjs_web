...
export default function Warehouse() {
    ...
    const src='/sheorancargomover8.jpg'
    return (
        <div>
            <Head>
            ...
            <Header2 />
            <Image width={1600} height={500} className='px-0' src='/sheorancargomover13.jpg' alt="warehouse-shifting"/>
