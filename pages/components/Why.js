...
function Why() {
    return (
        <div className='mt-4 '>
            <div  className='text-center text-2xl uppercase underline pointer text-black font-sans font-semibold px-4'>why choose us?</div>
            <p className="overflow-clip px-4 pt-2 txt-col text-center">
        ...
        <div className='text-yellow-400 pl-4 text-6xl mt-44'>10</div>
        <div className=''> 
        ...
        {/* https://media.istockphoto.com/photos/empty-shopping-cart-isolated-on-white-background-picture-id114308468?k=6&m=114308468&s=170667a&w=0&h=J3o0vf3jgFHOlo9JqHVZoA9VH8pzFkLLR8lkNTkb3nY= */}
           ...
           <p className="overflow-clip px-4 pt-2 text-bg txt-col text-center">
           ...
           <p className="overflow-clip px-4 pt-6 txt-col text-center pb-8">
           ...
           <div className='why-us-ring place-content-center flex flex-col md:flex-row p-8'>
               ...
               <SendIcon  style={{ fontSize: '48px' }}/>
                ...
                <p className="overflow-clip px-4 pt-2 txt-col text-white text-center">
