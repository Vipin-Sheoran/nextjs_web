...
function About() {
    return (
        <div className='about pb-4'>
             ...
             Max International Packers and Movers were established in the year 2008. We are a best name in packers and movers industry. As a dedicated part of service industry we are committed to come up with the best service providers. Our members provide packing, moving of any kind of goods as well as Automobile Transportation , they extend their services in relocating , home based shifting , corporate shifting , door to door cargo shifting.
             ...
             <button className='uppercase bt-color text-white px-2 mx-4 py-2 my-2'>know more</button>
        </div>
    )
}
